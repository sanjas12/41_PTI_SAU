...
class IntervalControl(QGroupBox):
    ...
    def __init__(self, parent=None):
        super().__init__("⏱ Интервал обновления", parent)
    ...
    def on_interval_changed(self, value: float):
        ...
        # Обновляем слайдер
        slider_value = int(value * 1000)  # Конвертируем в мс
    ...
    def on_slider_changed(self, value: int):
        ...
        interval = value / 1000.0  # Конвертируем из мс в секунды
