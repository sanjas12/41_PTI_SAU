...
class SignalType(Enum):
    ...
    def is_analog(self) -> bool:
        ...
        return self in [SignalType.SINE, SignalType.SQUARE, 
                       SignalType.SAWTOOTH, SignalType.TRIANGLE,
                       SignalType.RANDOM, SignalType.CUSTOM]
    
    def is_discrete(self) -> bool:
        """Проверить, является ли сигнал дискретным"""
        return self in [SignalType.DISCRETE, SignalType.PULSE,
                       SignalType.PWM, SignalType.STEP, SignalType.TOGGLE]
    
    @staticmethod
    def get_analog_types():
        """Получить список аналоговых типов"""
        return [SignalType.SINE, SignalType.SQUARE, 
                SignalType.SAWTOOTH, SignalType.TRIANGLE,
                SignalType.RANDOM, SignalType.CUSTOM]
    ...
    def get_discrete_types():
        ...
        return [SignalType.DISCRETE, SignalType.PULSE,
                SignalType.PWM, SignalType.STEP, SignalType.TOGGLE]